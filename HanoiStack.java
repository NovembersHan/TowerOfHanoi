...
public class HanoiStack {
	...
	public void moveDisk() {
		if (pole1.empty()) { // if pole1 is empty, push the disk on the top of pole2 to pole1
        		pole1.push(pole2.pop());
        		System.out.println("Move disk from pole "+index2 + " to pole "+index1);
        	} else if (pole2.empty()) { // if pole2 is empty, push the disk on the top of pole1 to pole2
